namespace PuertsStaticWrap
{
    public static class AutoStaticCodeRegister
    {
        public static void Register(Puerts.JsEnv jsEnv)
        {
            ...
            jsEnv.AddLazyStaticWrapLoader(typeof(GT.GTJSManager), GT_GTJSManager_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(GT.GTJSBehaviour), GT_GTJSBehaviour_Wrap.GetRegisterInfo);
            jsEnv.AddLazyStaticWrapLoader(typeof(GT.GTPuertsAdaptor), GT_GTPuertsAdaptor_Wrap.GetRegisterInfo);
