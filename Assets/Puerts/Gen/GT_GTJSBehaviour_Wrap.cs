...
{
    public static class GT_GTJSBehaviour_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new GT.GTJSBehaviour();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(GT.GTJSBehaviour), result);
                    }
                }
        ...
        private static void G_ModuleName(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as GT.GTJSBehaviour;
